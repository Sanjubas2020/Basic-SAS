...
data new;
var='S13@#%874541UDHAKAR   1478konduru:;,.'; output; /** output statement will print the data into the output dataset **/
...
index_func=index(name,'k'); put index_func=;
...
/** Day-6 Assignment **/
/** i want to extract middle name only **/
data new;
length name $30;
name='sudhaKar konduru  '; output;
name='madhan mohan  kumar gurram '; output;
name='manikanta manohar valavala'; output;
name='lakshmI sravani sunKari'; output;
name='prit patel'; output;
run;
...
data new1;
set new;
middle_name = scan(name, 2, " "); /*what if there is no middle name*/
run;
...
data new2;
length name $30;
name='sudhaKar.konduru@rangtech.com'; output;
name='madhan.mohan.kumar.gurram@rangtech.com '; output;
name='manikanta.manohar.valavala@rangtech.com'; output;
name='lakshmI.sravani.sunKari@rangtech.com'; output;
name='prit.patel@rangtech.com'; output;
run;


data new3;
set new2;
length rang_email $30;
rang_email= substr(name,find(name,"@"),15);
run;
/** here i want to extract rangtech.com only in the string **/
